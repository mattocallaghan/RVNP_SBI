...
"""
Pendulum Task configuration variant: tests10000_hybrid_shrink0.0_wellspec
...
def get_config():
    ...
    config.training.workspace = 'output/pendulum_task_tests10000_hybrid_shrink00_wellspec'
