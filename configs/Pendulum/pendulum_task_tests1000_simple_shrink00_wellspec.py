...
"""
Pendulum Task configuration variant: tests1000_simple_shrink0.0_wellspec
...
def get_config():
    ...
    config.training.workspace = 'output/pendulum_task_tests1000_simple_shrink00_wellspec'
