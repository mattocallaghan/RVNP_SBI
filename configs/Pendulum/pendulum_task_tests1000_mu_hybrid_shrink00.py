...
"""
Pendulum Task configuration variant: tests1000_hybrid_shrink00
...
def get_config():
    ...
    config.model.correction_type = 'global'  # 'simple', 'diagonal_neural', or 'hybrid'
    ...
    config.training.workspace = 'output/pendulum_task_tests1000_mu_hybrid_shrink00'
