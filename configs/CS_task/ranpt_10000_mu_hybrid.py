...
def get_config():
    ...
    config.training.workspace='output/ranpt_cs_task_10000_mu_hybrid'
    ...
    config.model.flow_dimension=3  # CS parameters
    config.model.nn_block_dim=52
    config.data.summary_dim=0
    config.model.cond_dim=4  # CS observables
    ...
    config.model.simulator_samples_per_theta=32     # Sample 25 times per theta
