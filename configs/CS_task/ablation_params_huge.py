...
"""
ABLATION STUDY: Parameter Size - Huge
CS task with mu_hybrid correction, nn_block_dim=256
...
def get_config():
    ...
    config.training.workspace='output/ablation_cs_params_huge_nobs100'
    ...
    config.model.nn_block_dim=256  # ABLATION: Huge parameter size
