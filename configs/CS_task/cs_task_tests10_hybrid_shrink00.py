...
"""
CS Task configuration variant: tests10_hybrid_shrink0.0
...
def get_config():
    ...
    config.training.workspace = 'output/cs_task_tests10_hybrid_shrink00'
    ...
    config.model.correction_type='hybrid'  # Override base config's 'simple'
    return config