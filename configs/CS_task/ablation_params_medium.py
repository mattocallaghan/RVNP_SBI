...
"""
ABLATION STUDY: Parameter Size - Medium (Baseline)
CS task with mu_hybrid correction, nn_block_dim=52
...
def get_config():
    ...
    config.training.workspace='output/ablation_cs_params_medium_nobs100'
    ...
    config.model.nn_block_dim=52  # ABLATION: Medium parameter size (baseline)
    ...
    config.model.lambda_shrinkage=0.0  # ABLATION: No shrinkage
