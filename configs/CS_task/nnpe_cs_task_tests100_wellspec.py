from configs.CS_task.nnpe_cs_task import get_config as get_base_config

"""
NNPE CS Task configuration variant: tests100_wellspec
Well-specified evaluation using training data as inference set
Inherits from base nnpe_cs_task.py and overrides only the inference dataset
"""

def get_config():
    # Get base configuration from nnpe_cs_task.py
    ...
    config.training.workspace = 'output/nnpe_cs_task_tests100_wellspec'
