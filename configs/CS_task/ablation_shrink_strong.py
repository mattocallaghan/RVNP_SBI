...
"""
ABLATION STUDY: Shrinkage Prior - Strong
CS task with mu_hybrid correction, lambda_shrinkage=1.0
...
def get_config():
    ...
    config.training.workspace='output/ablation_cs_shrink_strong_nobs100'
    ...
    config.model.correction_lambda_shrinkage=1.0
    ...
    config.model.lambda_shrinkage=1.0  # ABLATION: Strong shrinkage
