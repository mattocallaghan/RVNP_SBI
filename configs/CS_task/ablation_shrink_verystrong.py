...
"""
ABLATION STUDY: Shrinkage Prior - Very Strong
CS task with mu_hybrid correction, lambda_shrinkage=10.0
...
def get_config():
    ...
    config.training.workspace='output/ablation_cs_shrink_verystrong_nobs100'
    ...
    config.model.correction_lambda_shrinkage=10.0
    ...
    config.model.lambda_shrinkage=10.0  # ABLATION: Very strong shrinkage
