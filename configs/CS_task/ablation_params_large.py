...
"""
ABLATION STUDY: Parameter Size - Large
CS task with mu_hybrid correction, nn_block_dim=128
...
def get_config():
    ...
    config.training.workspace='output/ablation_cs_params_large_nobs100'
    ...
    config.model.nn_block_dim=128  # ABLATION: Large parameter size
