...
"""
ABLATION STUDY: Shrinkage Prior - Medium
CS task with mu_hybrid correction, lambda_shrinkage=0.1
...
def get_config():
    ...
    config.training.workspace='output/ablation_cs_shrink_medium_nobs100'
    ...
    config.model.correction_lambda_shrinkage=0.1
    ...
    config.model.lambda_shrinkage=0.1  # ABLATION: Medium shrinkage
