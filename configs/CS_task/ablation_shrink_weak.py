...
CS task with mu_hybrid correction, lambda_shrinkage=0.01
...
def get_config():
    ...
    config.model.correction_lambda_shrinkage=0.01
    ...
    config.model.lambda_shrinkage=0.01  # ABLATION: Weak shrinkage
