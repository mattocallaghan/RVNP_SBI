...
"""
Gaussian_Mixture Task configuration variant: tests1000_simple_shrink10
...
def get_config():
    ...
    config.model.lambda_shrinkage = 1.0
    
    # Update workspace to reflect the specific configuration
    config.training.workspace = 'output/gaussian_mixture_task_tests1000_simple_shrink10'
