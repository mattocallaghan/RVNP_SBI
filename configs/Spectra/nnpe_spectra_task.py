...
"""
NNPE (Noisy Neural Posterior Estimation) configuration for Spectra task
...
def get_config():
    ...
    config.training.workspace='output/nnpe_Spectra_100000'
    ...
    config.sampling.sampling_name='nnpe_embedding'
    ...
    # NNPE spike-and-slab parameters
    config.model.slab_scale = 1.0    # Scale for heavy-tailed slab component
    config.model.spike_scale = 0.01  # Scale for concentrated spike component
    ...
    config.model.lambda_shrinkage=1.00
