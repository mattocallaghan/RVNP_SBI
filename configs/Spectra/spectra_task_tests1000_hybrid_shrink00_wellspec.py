...
"""
Spectra Task configuration variant: tests1000_hybrid_shrink0.0_wellspec
...
def get_config():
    ...
    config.training.workspace = 'output/spectra_task_tests1000_hybrid_shrink00_wellspec'
    ...
    config.model.train_embeddings=False       # Use pre-trained embeddings    
    return config