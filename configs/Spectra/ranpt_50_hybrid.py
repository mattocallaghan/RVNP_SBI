...
def get_config():
    ...
    config.training.workspace='output/ranpt_spectra_task_50_hybrid'
    ...
    config.data.vector_dim_inference=300 # Spectra data
    ...
    config.model.cond_dim=5  # Spectra uses embedding_dim=5
