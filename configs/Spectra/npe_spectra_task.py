...
"""
NPE (Neural Posterior Estimation) configuration for Spectra task
Uses standard neural posterior estimation with maximum likelihood training - no corruption or complex staging
Includes embedding support for high-dimensional spectral data
"""
...
def get_config():
    ...
    # constants
    #################################
    config.training.workspace='output/npe_Spectra_100000'
    ...
    config.model.embedding_dim=5  # Embedding dimension for spectra data
    config.model.flow_dimension=3  # Dimension of θ (spectra parameters) - what we're learning posterior for
    ...
    config.data.vector_dim=3  # Low-dimensional after embedding
    ...
    # Enable embeddings for high-dimensional spectra data
