...
"""
RANPT configuration for Spectra task
...
def get_config():
    ...
    config.training.workspace='output/ranpt_spectra_task_5_hybrid'
    config.data.num_simulations = int(125711/1.1)      # For custom datasets (if applicable).
    ...
    config.data.vector_dim_inference=3 # Spectra has 3 parameters
    ...
    config.model.correction_type='hybrid'  # 'hybrid', 'diagonal_neural', or 'neural'
