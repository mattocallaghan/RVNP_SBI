...
"""
RANPT configuration for SIR task
...
def get_config():
    ...
    config.training.workspace='output/ranpt_sir_task_1_mu_hybrid'
    ...
    config.data.vector_dim_inference=2 # SIR has 2 parameters
    ...
    config.model.flow_dimension=2  # SIR parameters
    config.model.nn_block_dim=52
    config.data.summary_dim=0
    config.model.cond_dim=6  # SIR has 6 observables
    ...
    config.model.correction_type='mu_hybrid'  # 'simple', 'diagonal_neural', or 'neural'
