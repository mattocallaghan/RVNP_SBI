from configs.SIR.npe_sir_task import get_config as get_base_config

"""
NPE SIR Task configuration variant: tests100_wellspec
Well-specified evaluation using training data as inference set
Inherits from base npe_sir_task.py and overrides only the inference dataset
"""

def get_config():
    # Get base configuration from npe_sir_task.py
    ...
    config.training.workspace = 'output/npe_sir_task_tests100_wellspec'
