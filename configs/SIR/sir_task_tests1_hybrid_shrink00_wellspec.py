...
"""
SIR Task configuration variant: tests1_hybrid_shrink0.0_wellspec
...
def get_config():
    ...
    config.training.workspace = 'output/sir_task_tests1_hybrid_shrink00_wellspec'
    config.training.batch_size = 2**10
    config.training.warmup_epochs=0  # Epochs for stages 1-4.5 (warmup)
