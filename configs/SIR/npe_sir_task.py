...
"""
NPE (Neural Posterior Estimation) configuration for SIR task
...
def get_config():
    ...
    # constants
    #################################
    config.training.workspace='output/npe_SIR_100000'
    ...
    #################################
    config.data.julia_env_path="/opt/homebrew/bin/julia"
    #################################
    # training parameters
    #################################
