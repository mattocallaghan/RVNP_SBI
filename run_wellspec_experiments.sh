...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  bash run_wellspec_experiments.sh --task=CS --method=RVNP-mu_hybrid"
...
if [ "$STATUS_ONLY" = true ]; then
    ...
    python integrated_pipeline.py --status --results-dir="$RESULTS_DIR" --wellspec
    echo ""
...
CMD="python integrated_pipeline.py --results-dir=$RESULTS_DIR --wellspec"
